...
function Home() {
  ...
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MzEsInJvbGUiOiJ1c2VyIiwidXNlcm5hbWUiOiJ0ZXN0MTIzNCIsImVtYWlsIjoidGVzdDk5QGdtYWlsLmNvbSIsImlhdCI6MTc1NDQ3NTQzNSwiZXhwIjoxNzU0NTA0MjM1fQ.y5_zpXe3aWwLJKcCbNojWlkJb2GHP-zEck2kG2hJGWQ";
  ...
  const removeItem = async () => {
    try {
      const response = await fetch(
        `http://localhost:3000/cart/delete-item/${pizza.id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
